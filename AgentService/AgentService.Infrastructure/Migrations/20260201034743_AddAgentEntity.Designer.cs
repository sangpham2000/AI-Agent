...
namespace AgentService.Infrastructure.Migrations
{
    ...
    [Migration("20260201034743_AddAgentEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgentService.Domain.Entities.Agent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("FlowiseChatflowId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("flowise_chatflow_id");

                    b.Property<string>("FlowiseConfig")
                        .HasColumnType("text")
                        .HasColumnName("flowise_config");
            ...
            modelBuilder.Entity("AgentService.Domain.Entities.DocumentChunk", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_uploaded_file_chunks");

                    b.HasIndex("DocumentId")
                        .HasDatabaseName("ix_uploaded_file_chunks_document_id");

                    b.ToTable("uploaded_file_chunks", (string)null);
                });
            ...
            modelBuilder.Entity("AgentService.Domain.Entities.DocumentChunk", b =>
                {
                    b.HasOne("AgentService.Domain.Entities.Document", "Document")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_uploaded_file_chunks_uploaded_files_document_id");
