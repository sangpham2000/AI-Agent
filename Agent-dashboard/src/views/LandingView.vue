...
<template>
  <div class="bg-base-100 relative overflow-hidden flex flex-col">
    <!-- Dynamic Background Fixed for Parallax like effect -->
    <div class="fixed inset-0 bg-grid-pattern opacity-[0.4] z-0 pointer-events-none"></div>

    <!-- Gradient Blobs (Fixed or Absolute) -->
    <div
      class="fixed top-[-20%] right-[-10%] w-[800px] h-[800px] bg-primary/20 rounded-full blur-3xl opacity-40 animate-pulse pointer-events-none z-0"
      style="animation-duration: 10s"
    ></div>
    <div
      class="fixed bottom-[-20%] left-[-10%] w-[600px] h-[600px] bg-secondary/20 rounded-full blur-3xl opacity-40 animate-pulse pointer-events-none z-0"
      style="animation-duration: 8s"
    ></div>

    <!-- Hero Section -->
    <section id="hero" class="min-h-[calc(100vh-64px)] flex flex-col justify-center relative z-10">
      <div
        class="flex-1 flex flex-col lg:flex-row items-center justify-center container mx-auto px-4 py-12 lg:py-20 gap-16"
      >
        <!-- Hero Content (Left) -->
    ...
    <section id="solutions" class="min-h-screen flex flex-col justify-center">
      <SolutionsView />
    </section>

    <section id="pricing" class="min-h-screen flex flex-col justify-center">
      <PricingView />
    </section>

    <section id="resources" class="min-h-screen flex flex-col justify-center">
      <ResourcesView />
    </section>
  </div>
</template>
...
<style scoped>
/* Smooth scrolling is often handled globally, but we ensure it here if we were using router-less */
</style>
